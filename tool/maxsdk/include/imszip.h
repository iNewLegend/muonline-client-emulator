...
public:
	...
	virtual BOOL FileInPackage(TCHAR* file_name, MSTR& extract_dir)=0;	// unload & run zip package, return extract-to directory
	...
	\return  TRUE if successful, otherwise FALSE. */
	virtual BOOL UnloadPackage(TCHAR* file_name, MSTR& extract_dir, 
