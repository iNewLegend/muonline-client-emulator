...
public:
	...
	virtual void SetElementName( MCHAR* newName )=0; 
...
public:
	...
	The name to set for the UI\n\n
	  */
	virtual void SetFileName( MCHAR* newName) = 0;
	...
	The name for the full file name\n\n
	  */
	virtual void SetFileType( MCHAR* newType) = 0;
...
public:
	...
	/*! \remarks This method allows you to set the output path for a
	Combustion format output file.
	\par Parameters:
	<b>const MCHAR *combustionOutputPath</b>\n\n
	The path string. */
	virtual void SetCombustionOutputPath(const MCHAR *combustionOutputPath) = 0;
	/*! \remarks This method allows you to set the output path for a
	Combustion format output file.
	\par Parameters:
	<b>const MSTR\& combustionOutputPath</b>\n\n
	The path string. */
	virtual void SetCombustionOutputPath(const MSTR& combustionOutputPath) = 0;
	/*! \remarks This method returns the output path for a Combustion format
	file. */
	virtual const MSTR& GetCombustionOutputPath() const = 0;
	/*! \remarks This method returns the output path for a Combustion format
	file. */
	virtual const MCHAR* GetCombustionOutputPathPtr() const = 0;
