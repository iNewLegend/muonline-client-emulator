...
public:
	...
	//! \return the name of  the map file if one exists, otherwise returns NULL
	virtual TCHAR *MaxMapFile() =0;
	...
	virtual bool LoadMaxAnimationFile(int loadOption,TCHAR *filename, TCHAR *mapfilename=NULL) =0;
...
public:
	...
	virtual bool AppendMaxClip(TCHAR *fname, TCHAR *mapFile = NULL, int interval = 5)=0;
...
public:
	...
	BIPExport bool AddMaxMixer(INodeTab &nodes, TCHAR *nameOfMix);
	...
	BIPExport bool AddMaxMixer(Tab<NodeAndAnims> &nodeAnims,TCHAR *nameOfMix);
