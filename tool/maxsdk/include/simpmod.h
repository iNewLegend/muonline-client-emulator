...
<b>SimpleMod</b> uses a single parameter block then <b>SimpleMod</b> can manage
all the methods associated with SubAnims and References for the client.\n\n
If the client of <b>SimpleMod</b> maintains several parameter blocks then the
client must implement the methods <b>NumSubs(), SubAnim(i), SubAnimName(i),
NumRefs(), GetReference(i)</b> and <b>SetReference(i)</b> and call the
<b>SimpleMod</b> methods when 'i' refers to the parameters maintained by
<b>SimpleMod</b>.\n\n
When clients of <b>SimpleMod</b> are cloning themselves, they should call this
method on the clone to copy <b>SimpleMod</b>'s data.\n\n
<b>void SimpleModClone(SimpleMod *smodSource);</b>\n\n
Clients of <b>SimpleMod</b> probably want to override these. If they do they
should call these from within their implementation of these methods.\n\n
...
class IParamBlock2;
/*! \sa  Class SimpleMod, Class IParamBlock2.\n\n
\par Description:
This class is available in release 3.0 and later only.\n\n
This version of class <b>SimpleMod</b> is provided for use with the parameter
block 2 system. It has a public data member <b>IParamBlock2 *pblock2</b> used
instead of the <b>IParamBlock *pblock</b> provided by <b>SimpleMod</b>. It also
provides implementations of <b>ReferenceMaker::GetReference()</b> and
<b>SetReference()</b> which get and set the <b>pblock2</b> pointer.
\par Data Members:
