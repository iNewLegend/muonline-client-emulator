...
/** This is NOT just a bitmask, the parameter is also used to stuff pointers, hence the ULONG_PTR. SR NOTE64: */
...
/*! \defgroup partid_node_global_illumination_property Node Gloabl Illumination Property PartIDs
...
REF_STOP to terminate further propogation of the message. */
...
CA recieved a \ref REFMSG_CHANGE, a REF_STOP result was returned stopping propagation to dependents. This
...
//@{
		...
		*/
		...
		/*! In the ReferenceTarget::Clone() procedure when an item is cloning 
			...
			\param  oldTarg - This is the item that is to be copied.
		...
		*/
		...
		/*!  This method is used by system plugins.
		\param  patchThis - The pointer should point at this item.
...
class CoreExport RefList: public MaxHeapOperators {
	public:
		//! \brief Public member that points to the first item in the reference list
		RefListItem* first;	
		...
		/*! \param  hmaker - The item to delete.
		...
		*/
		...
		\param  hmaker - Handle to the ReferenceMaker
...
//@{
		...
		default behaviour. See bool UtilityInterface::GetBoolEnvironmentVariable(TCHAR* pEnvVar, bool defaultVal) 
		for the values this environemnt variable can take.\n\n
		...
		the default behaviour. See bool UtilityInterface::GetBoolEnvironmentVariable(TCHAR* pEnvVar, bool defaultVal) 
		for the values this environemnt variable can take.
		...
		*/
		...
		/*! This deletes all reference to and from, sends REFMSG_TARGET_DELETED messages, 
		handles UNDO, and deletes the object.
		*/
...
//@{
		...
		/*! The plugin implements this method to return the number 
		...
		*/
		...
		/*! The plugin implements this method to return its 
		...
		\param  i - The virtual array index of the reference to get.
		...
		*/
		...
		/*! The plugin implements this method to store the reference
...
//@{ 
		...
		/*! Put something here
			\param  changeInt - Put something here
			\param  partID - Put something here
			\param  message - Put something here
			\param  sclass - Put something here
			\param  propagate - Put something here
			\param  hTarg - Put something here
...
//@{ 
		...
		\param  nameEnum - The Callback object that gets called on all
		Auxillary files.
		\param  flags - Flags.
		*/ 
...
//@{ \name Cloning
		...
		//! cloning an object.
		/*! This method is called to have the plugin clone 
		...
		\param  remap - This class is used for remapping references during a
		Clone.
...
//@}
	...
	private:		
		...
		\param  whichRef - which reference to set. If -1, SetReference is not called on hmaker
...
class DependentIterator: public MaxHeapOperators {
	...
	//! \brief Constructor
	/*! \param  rtarg - Points to the RefereceTarget whose dependents are
		iterated through. */
...
public:
	...
	\param  macroRecToo - disable/enable macro recorder system
	\param  setKeyModeToo - disable/enable set key system
	\param  refMsgsToo - disable/enable passing of reference messages
	*/
	AnimateSuspend(
...
public:
	//! Constructor
	/*!	Create an instance of this class, setting the specified MAX states.
	\param  holdState - disable/enable hold system
	\param  macroRecorder - disable/enable macro recorder system
	\param  animateMode - disable/enable animate mode
	\param  setKeyMode - disable/enable set key system
	\param  autoBackup - disable/enable auto backup
	\param  saveRequired - save/restore save required flag
	\param  refMsgs - disable/enable passing of reference messages
	*/
	SuspendAll(
