...
#ifndef __ILAYERANIMATION_H
#define __ILAYERANIMATION_H
...
public:
	...
	virtual void AddLayer(TSTR &name, Tab<INode *> &nodeTab, bool useActiveControllerType)=0;
	...
	virtual void SetLayerName(int index, TSTR name)=0;
	...
	virtual TSTR GetLayerName(int index)=0;
	...
	/*! \internal !*/
	virtual TCHAR *GetComboToolTip() =0;
