...
/*! \remarks This global function is not part of this class but is available
for use. It creates and returns a pointer to a new Note Track.
\par Data Members:
<b>NoteKeyTab keys;</b>\n\n
The table of note keys for the track. <br>  The methods of this class are all
