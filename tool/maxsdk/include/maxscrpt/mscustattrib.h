...
{
public:
	ScripterExport static Tab<MSCustAttribDef*> ms_attrib_defs; // table of existing scripted attribute defs to enable redefinition
...
public:
	...
	void			SetName(MCHAR* newName)	{ name = newName ; }
