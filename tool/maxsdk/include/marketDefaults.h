 ...
 */
CoreExport MSTR GetMarketDefaultsFileName(const TCHAR* name = NULL);
 ...
 */
CoreExport TSTR GetMarketDefaultsWriteLocation();
...
// This class generates range checkers for values. 
template<class T, int low, int high>
class MarketDefaults::Range : public MaxHeapOperators {
public:
