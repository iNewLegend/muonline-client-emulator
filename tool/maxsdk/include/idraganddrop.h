...
The URLTab class is a <b>Tab\<TCHAR*\></b> utility class that is used by
...
public:
   ...
   CoreExport URLTab& operator=(const Tab<TCHAR*>& tb);
   /*! \remarks Assignment operator. */
   ...
   <b>MCHAR* url</b>\n\n
   The new URL string. */
   CoreExport void Change(int i, TCHAR* url);
...
<b>static TSTR download_directory;</b>\n\n
