...
public:
	...
	virtual bool AddToolbar(MCHAR *name)=0;
	virtual bool DeleteToolbar(int index)=0;
	virtual bool DeleteToolbar(MCHAR *name)=0;
	virtual MCHAR* GetToolbarName(int index)=0;
	virtual void ShowToolbar(MCHAR *name)=0;
	virtual void HideToolbar(MCHAR *name)=0;
	virtual bool IsToolbarVisible(MCHAR *name)=0;
	...
	virtual void SaveUILayout(MCHAR* name)=0;
	virtual void LoadUILayout(MCHAR* name)=0;
...
class ITreeViewOps : public FPMixinInterface {
	public:
		...
		*/
		...
		virtual void SetTVName(MCHAR *)=0;
...
class ITrackViewArray : public FPStaticInterface
	...
	public:	
		...
		ITreeViewOps* GetTrackView(MSTR name);
		...
		BOOL IsTrackViewOpen(MSTR name);
		/*! \remarks This method returns TRUE if the specified trackview is
		open, otherwise FALSE.
		\par Parameters:
		<b>int index</b>\n\n
		...
		BOOL OpenTrackViewWindow(MSTR name, MSTR layoutName = _M(""), Point2 pos = Point2(-1.0f,-1.0f), 
		...
		void DeleteTrackView(MSTR name);
		/*! \remarks This method deletes the specified trackview from the list
		of saved trackviews.
		\par Parameters:
		<b>int index</b>\n\n
		...
		*/
		...
		<b>MSTR name</b>\n\n
		The name of the trackview. */
		BOOL IsTrackViewCurrent(MSTR name);
		...
		<b>MSTR name</b>\n\n
		The name of the trackview. */
		BOOL SetTrackViewCurrent(MSTR name);
		...
		BOOL TrackViewZoomSelected(MSTR tvName);
		...
		The sub-anim index.
		\return  TRUE if zooming was successful, FALSE if it failed. */
		BOOL TrackViewZoomOn(MSTR tvName, Animatable* anim, int subNum);
