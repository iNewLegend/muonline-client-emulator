...
#ifndef _IDX10HARDWARERENDERER_H_
#define _IDX10HARDWARERENDERER_H_
...
*/
typedef struct D3D10SceneLight : public MaxHeapOperators
{
	/*! %Light position*/
...
}D3D10SceneLight, *lpD3D10SceneLight;
