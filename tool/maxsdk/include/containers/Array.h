...
public:
	...
	*/
	...
	/*!	\brief Sets the element, at the given index, to the given value.
		\param[in] index - The index of the element to be modified. This index 
		must be within the array bounds.
		\param[in] value - The value to which the element will be set.
		\return A reference to 'this'.
		\remarks Does not implement bounds checking.
	*/
	...
	*/
	...
	/*!	\brief Appends a single element to the array.
		\param[in] value - The value to be appended to the array.
