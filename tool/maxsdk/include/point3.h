...
class DllExport Point3: public MaxHeapOperators {
public:
   float x,y,z;
...
DllExport Point3 FNormalize(const Point3&); // Fast normalize 
...
DllExport Point3 CrossProd(const Point3& a, const Point3& b);  // CROSS PRODUCT
