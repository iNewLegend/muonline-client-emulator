...
// This is also used to store string pointers, hence the _PTR' type.
typedef INT_PTR StringResID;
typedef int ResID;                     // SR NOTE64: Was INT_PTR
...
#define P_INCLUDED		    0x0000000020000000 // included from another descriptor, don't double free
...
class IParamBlock2 : public ReferenceTarget 
{
	public:
		...
		*/
		virtual BOOL SetValue(ParamID id, TimeValue t, MCHAR* v, int tabIndex=0)=0;
		...
		*/
		...
		TYPE_FILENAME or TYPE_STRING
		*/
		virtual BOOL GetValue(ParamID id, TimeValue t, MCHAR*& v, Interval &ivalid, int tabIndex=0)=0;
		...
		*/
		...
		TYPE_FILENAME or TYPE_STRING
		*/
		virtual MCHAR*		GetStr(ParamID id, TimeValue t=0, int tabIndex=0)=0;
...
class ClassDesc2 : public ClassDesc 
{
	...
	public:
		...
		*/
		...
		\param updateUI  If TRUE to user inteface is updated. If FALSE it's not.
		\param callSetHandlers  TRUE to call <b>PBAccessor::Set()</b> for all the parameters; otherwise FALSE. */
...
static ParamBlockDesc2 geo_param_blk ( geo_params, _T("GeosphereParameters"),
...
If neither P_REF_NO or P_OWNERS_REF is set, the parameter block owns and maintains the reference. \n\n
<b>P_CAN_CONVERT</b> \n
...
*/
	...
	*/
	...
	of the value to set.
	\return  TRUE on success; otherwise FALSE. */
	BOOL SetValue(ParamID id, TimeValue t, MCHAR* v, int tabIndex=0) { return class_params->SetValue(id, t, v, tabIndex); }
	/*! \remarks This method is used with static class parameter blocks
	only.\n\n
	...
	the value to get.
	\return  TRUE on success; otherwise FALSE. */
	BOOL GetValue(ParamID id, TimeValue t, MCHAR*& v, Interval &ivalid, int tabIndex=0) { return class_params->GetValue(id, t, v, ivalid, tabIndex); }
	/*! \remarks This method is used with static class parameter blocks only.\n\n
	...
	of the value to get.
	\return  The TimeValue value of the parameter. */
	PB2Export MCHAR*		GetStr(ParamID id, TimeValue t=0, int tabIndex=0);
	/*! \remarks This method is used with static class parameter blocks
	only.\n\n
	Returns the value of the specified parameter at the specified time.
	\par Parameters:
	...
	*/
	PB2Export void SetFileTypes(ParamID id, TCHAR * fileType);
};
