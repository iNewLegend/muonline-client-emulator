...
public:
	...
	/*!	This method lets you update the vertex positions of the DirectX mesh cache.  This allow you to 
		keep the directx mesh cache around without having to delete it on geometric changes.
...
public:
	...
	*/
 	virtual BOOL D3DHWMeshCacheManagerAddHWMesh( INode *node, DWORD_PTR pMesh, Material *mtl, HardwareMaterial *pHWMat, Point3 wireframeColor, Matrix3 *tmOverRide, DWORD attr, DWORD renderLimit) = 0;
