========================================================================
    정적 라이브러리 : MDatabase 프로젝트 개요
========================================================================

응용 프로그램 마법사에서 이 MDatabase 라이브러리 프로젝트를 만들었습니다. 
이 파일에는 MDatabase 응용 프로그램을 구성하는 각각의 파일에
