...
void MComboBox::MultiplySize( float byIDLWidth, float byIDLHeight, float byCurrWidth, float byCurrHeight )
{
	MButton::MultiplySize(byIDLWidth, byIDLHeight, byCurrWidth, byCurrHeight);

	m_nDropHeight = int(m_nDropHeight * byCurrHeight);
}