...
int MMatchMonitor::OnConnected(MUID* pTargetUID, MUID* pAllocUID, MCommObject* pCommObj)
{
...
bool MMatchMonitor::OnSockConnect(SOCKET sock)
{
...
bool MMatchMonitor::OnSockDisconnect(SOCKET sock)
{
...
bool MMatchMonitor::OnSockRecv(SOCKET sock, char* pPacket, DWORD dwSize)
{
...
void MMatchMonitor::OnSockError(SOCKET sock, SOCKET_ERROR_EVENT ErrorEvent, int &ErrorCode)
{
...
void MMatchMonitor::OnRegisterCommand(MCommandManager* pCommandManager)
{
...
bool MMatchMonitor::OnCommand(MCommand* pCommand)
{
...
void MMatchMonitor::OnResponseObjectList(int nMapID, int nCellID, MOBJECTBASICINFO* pObjBIArray, int nObjBIArrayCount)
{
...
void MMatchMonitor::OnResponseObjectList(int nMapID, MOBJECTBASICINFO* pObjBIArray, int nObjBIArrayCount)
{
...
void MMatchMonitor::OnResponseObjectCacheUpdate(MOBJECTCACHEINFO* pObjBIArray, int nObjBIArrayCount)
{
...
void MMatchMonitor::OnResponseObjectBasicInfoUpdate(MBLOB_BASICINFO_UPDATE* pObjBIArray, int nObjBIArrayCount)
{
...
void MMatchMonitor::OutputLocalInfo(void)
{
...
MMatchMonitor::MMatchMonitor(void)
{
	m_Server.SetInvalid();
}

/*
bool MMatchMonitor::Create(int nPort)
{
...
void MMatchMonitor::Destroy(void)
{
	MClient::Destroy();
}
*/
