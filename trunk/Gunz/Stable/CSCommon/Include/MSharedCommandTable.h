...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// 주의 : 커맨드 ID를 수정하면 기존에 저장한 리플레이 파일이 재생되지 않을 수 있습니다.
//
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
#define MC_ADMIN_REQUEST_KICK_PLAYER			515		///< 타겟 접속 끊기 요청
#define MC_ADMIN_RESPONSE_KICK_PLAYER			516		///< 타겟 접속 끊기 응답
#define MC_ADMIN_REQUEST_MUTE_PLAYER			517		///< 타겟 채팅 금지 요청
#define MC_ADMIN_RESPONSE_MUTE_PLAYER			518		///< 타겟 채팅 금지 응답
#define MC_ADMIN_REQUEST_BLOCK_PLAYER			519		///< 타겟 접속 블럭 요청
#define MC_ADMIN_RESPONSE_BLOCK_PLAYER			520		///< 타겟 접속 블럭 응답
...
#define MC_MATCH_LOGIN_NHNUSA					1011	///< 미국 NHN에서 로그인.
#define MC_MATCH_LOGIN_GAMEON_JP				1012	///< 일본 gameon에서 로그인
...
#define MC_MATCH_CHANNEL_DUMB_CHAT				1227	///< 채널에서 대화 차단, 벙어리 기능 - 홍기주(2009.08.05)
...
#define MC_MATCH_STAGE_LEAVEBATTLE_TO_SERVER	1403	///< 스테이지 전투탈퇴(C -> S)
#define MC_MATCH_STAGE_LEAVEBATTLE_TO_CLIENT	1404	///< 스테이지 전투탈퇴(S -> C)
...
#define MC_MATCH_STAGE_RELAY_LAUNCH				1433	///< 릴레이된 스테이지 실행
...
#define MC_MATCH_RESPONSE_SUICIDE_RESERVE		1533	///< 자살 예약.
#define MC_MATCH_NOTIFY_THROW_TRAPITEM			1535	///< 트랩아이템 투척 알림(C -> S)
#define MC_MATCH_NOTIFY_ACTIVATED_TRAPITEM		1536	///< 트랩아이템 발동 알림(C -> S)
#define MC_MATCH_NOTIFY_ACTIATED_TRAPITEM_LIST	1437	///< 난입한 유저에게 현재 발동 중인 트랩아이템 목록 알려주기(S -> C)
...
#define MC_RESPONSE_GAMBLEITEMLIST				1827	///< DB의 겜블 아이템 정보 전송.
#define MC_MATCH_ROUTE_UPDATE_STAGE_EQUIP_LOOK	1828	///< 캐릭터의 Look만들 업데이트할때 사용한다.
#define MC_MATCH_REQUEST_CHARACTER_ITEMLIST_FORCE	1829	///< 내 아이템 리스트 주시오 : 중복 요청도 무시하지 않는 버전(주의해서 사용할것)
...
#define MC_MATCH_REQUEST_GAMBLE					1841	///< 뽑기 (C -> S)
#define MC_MATCH_RESPONSE_GAMBLE				1842	///< 뽑기 결과 (S -> C)

#define MC_MATCH_REWARD_BATTLE_TIME				1843	///< 배틀 시간 보상 공지(S->C)

// 아이템 관련(소모성)
#define MC_MATCH_REQUEST_USE_SPENDABLE_NORMAL_ITEM		1850	///< 일반 소모성 아이템 사용 요청(C -> S)
#define MC_MATCH_REQUEST_USE_SPENDABLE_BUFF_ITEM		1860	///< 버프 소모성 아이템 사용 요청(C -> S)
#define MC_MATCH_RESPONSE_USE_SPENDABLE_BUFF_ITEM		1861	///< 버프 소모성 아이템 사용 결과(S -> C)
#define MC_MATCH_SPENDABLE_BUFF_ITEM_STATUS				1865	///< 버프 소모성 아이템 상태(S -> C)
#define MC_MATCH_REQUEST_USE_SPENDABLE_COMMUNITY_ITEM	1870	///< 커뮤니티 소모성 아이템 사용 요청(C -> S)
...
#define MC_MATCH_DUELTOURNAMENT_REQUEST_JOINGAME				2300	///< 듀얼 토너먼트의 참가 신청(C -> S)
#define MC_MATCH_DUELTOURNAMENT_RESPONSE_JOINGAME				2301	///< 듀얼 토너먼트의 참가 신청에 대한 응답(S -> C)
#define MC_MATCH_DUELTOURNAMENT_REQUEST_CANCELGAME				2302	///< 듀얼 토너먼트의 참가 신청 취소(C -> S)
#define MC_MATCH_DUELTOURNAMENT_CHAR_INFO						2303	///< 듀얼 토너먼트의 케릭터 정보(S -> C)
#define MC_MATCH_DUELTOURNAMENT_PREPARE_MATCH					2304	///< 듀얼 토너먼트 시작 전
#define MC_MATCH_DUELTOURNAMENT_LAUNCH_MATCH					2305	///< 듀얼 토너먼트 시작! (S - > C)
#define MC_MATCH_DUELTOURNAMENT_CANCEL_MATCH					2306	///< 듀얼 토너먼트 취소! (S - > C)
#define MC_MATCH_DUELTOURNAMENT_CHAR_INFO_PREVIOUS				2307	///< 듀얼 토너먼트 캐릭터 지난주 정보(S -> C)
#define MC_MATCH_DUELTOURNAMENT_NOT_SERVICE_TIME				2308	///< 현재 듀얼토너먼트 서비스 시간이 아닙니다.(오픈시간 %s%d시00분 ~ %s%d시59분) (S - > C)

#define MC_MATCH_DUELTOURNAMENT_REQUEST_SIDERANKING_INFO		2400	///< 케릭터 랭킹의 근처 랭킹 정보 요청(C -> S)
#define MC_MATCH_DUELTOURNAMENT_RESPONSE_SIDERANKING_INFO		2401	///< 케릭터 랭킹의 근처 랭킹 정보 응답(S -> C)
#define MC_MATCH_DUELTOURNAMENT_GROUPRANKING_INFO				2402	///< 듀얼 토너먼트의 그룹 랭킹 정보(S -> C)

#define MC_MATCH_DUELTOURNAMENT_GAME_INFO						2500	///< 듀얼 토너먼트 게임 내에서의 정보
#define MC_MATCH_DUELTOURNAMENT_GAME_ROUND_RESULT_INFO			2501	///< 듀얼 토너먼트 게임 내에서의 라운드 승패 결과 정보
#define MC_MATCH_DUELTOURNAMENT_GAME_MATCH_RESULT_INFO			2502	///< 듀얼 토너먼트 게임 내에서의 매치 승패 결과 정보
#define MC_MATCH_DUELTOURNAMENT_GAME_PLAYER_STATUS				2503	///< 듀얼 토너먼트 게임 내에서의 라운드가 종료될 때, 해당 게이머의 상태를 서버로 보냄(C -> S)
#define MC_MATCH_DUELTOURNAMENT_GAME_NEXT_MATCH_PLYAERINFO		2504	///< 듀얼 토너먼트 게임 내에서의 다음 매치업의 플레이어 정보
...
#define MC_QUEST_NPCLIST					6014	///< 현제 퀘스트에서 사용할 NPC의 정보.(S->C) 
...
#define MC_QUEST_PEER_NPC_BOSS_HPAP			6047	///< 정기적으로 업데이트되는 NPC 보스 체력 아머
...
#define MC_QUEST_SURVIVAL_RESULT			6103	///< 서바이벌 결과 통보(S -> C)
#define MC_SURVIVAL_RANKINGLIST				6104	///< 서바이벌 상위 랭킹 목록 전송(S -> C)
#define MC_SURVIVAL_PRIVATERANKING			6105	///< 유저의 서바이벌 랭킹 정보 전송(S -> C)
...
// x-trap
#define MC_REQUEST_XTRAP_HASHVALUE					8001	///< 이전과의 호환으로 존재만(사용하지 않는다.)
#define MC_RESPONSE_XTRAP_HASHVALUE					8002	///< 이전과의 호환으로 존재만(사용하지 않는다.)
#define MC_REQUEST_XTRAP_SEEDKEY					8003	///< 암호키 요청(S -> C)
#define MC_RESPONSE_XTRAP_SEEDKEY					8004	///< 암호키 응답(C -> S)
#define MC_REQUEST_XTRAP_DETECTCRACK				8005	///< 이전과의 호환으로 존재만(사용하지 않는다.)
...
// 자수.
#define MC_REQUEST_GIVE_ONESELF_UP					9101	///< 자수하다.
...
#define MC_UDP_PING					10007	///< Client와 Agent들 사이의 ping을 측정하기위한 command
#define MC_UDP_PONG					10008	///< ping에 대한 응답
...
#define MC_PEER_DUELTOURNAMENT_HPAPINFO		10016	///< 정기적으로 업데이트되는 듀얼토너먼트 전용 캐릭터 체력/아머 정보
...
#define MC_PEER_BUFF_INFO			10056	///< 버프 이펙트를 전달(숏버프의 경우, 발동시 상대도 통지를 받으므로 따로 보내주지 않아도 된다)
											///< 그러나 난입자에게는 자신의 발동 중인 이펙트를 알려주어야 하므로 그때 사용한다)
