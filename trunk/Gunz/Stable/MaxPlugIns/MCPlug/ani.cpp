...
void MCplug2::DumpTMSample(INode* node, mesh_data* mesh_node)
{
	...
	mesh_node->m_tm_key = new t_tm_key_s[mat_key_cnt];
...
{	
	...
	mesh_node->m_pos_key = new t_pos_key_s[pos_key_cnt];
	memset(mesh_node->m_pos_key,0,sizeof(t_pos_key_s)*pos_key_cnt);
