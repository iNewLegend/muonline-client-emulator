...
DWORD MCRC32::BuildCRC32(const BYTE* pData, DWORD dwSize)
{
	DWORD dwCRC32 = 0xFFFFFFFF;
	return AccumulateCRC32(dwCRC32, pData, dwSize);
}

DWORD MCRC32::AccumulateCRC32(DWORD& dwCRC32, const BYTE* pData, DWORD dwSize)
{
