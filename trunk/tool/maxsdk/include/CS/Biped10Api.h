...
//@{
	...
	*/
	virtual INode *CreateXtra(int nlinks, TCHAR *name) = 0;
	...
	*/
	...
	\param[in] name - the base name of the Xtra
	*/
	virtual void SetXtraName(INode& xtraBase, TCHAR *name) = 0;

	//! \brief Gets the base name of an Xtra
	//! \param[in] xtrabase - the base node of the Xtra
	//! \return the base name of the Xtra
	virtual const TCHAR* GetXtraName(INode& xtraBase) = 0;
...
//@{
	...
	virtual bool SaveBipedAnimationLayer(const TCHAR *fname, int layerIndex) = 0;
	...
	*/
	virtual bool LoadBipedAnimationLayer(const TCHAR *fname, int layerIndex) = 0;
	...
	\return true if the save was successful, false if the save was unsuccessful
	*/
	virtual bool SaveBipedBaseAnimationLayer(const TCHAR *fname, 
	...
	\return true if the load was successful, false if the load was unsuccessful
	*/
	virtual bool LoadBipedBaseAnimationLayer(const TCHAR *fname, BOOL MatchFile, BOOL ZeroFootHeight, 
				BOOL promptForDuplicates, int retargetType, BOOL scaleIKObjectSize,
				int loadMaxObjects, Tab<TCHAR *> *maxObjectNames,
