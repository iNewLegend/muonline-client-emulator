...
object, use the following macro (defined in <b>ANIMTBL.H</b> ). Using this
...
following macro (defined in <b>ANIMTBL.H</b> ). Using this macro, given any
...
//! individual keys.\n
//! The interface ID is I_KEYCONTROL2 defined in animtbl.h.
...
<b>if (iWave) {</b>\n\n
<b>iWave-\>SetSoundFileName(_T("LedZep.wav"))</b>\n\n
<b>}</b>\n\n
All methods of this class are implemented by the system.  */
class IWaveSound: public MaxHeapOperators {
	public:
		// Retreives the name of the current sound file
		/*! \remarks Returns the name of the current sound file. */
		virtual MSTR GetSoundFileName()=0;
		...
		/*! \remarks Sets the sound file. This will cause the .WAV to be
		...
		otherwise TRUE. */
		virtual BOOL SetSoundFileName(MSTR name)=0;
...
mesh object, use the following macro (defined in <b>ANIMTBL.H</b> ). Using this
...
namespace LightingModel       // So client code can specify LighthingModel::kLightingOnly
{
   enum LightingModel {
...
\par Description:
This class is available in release 4.0 and later only.\n\n
This class represents the interface for the time slider. The interface ID is
...
This class is available in release 4.0 and later only.\n\n
All methods of this class are Implemented by the System.\n\n
This class represents the interface for the Bitmap IO BMP format. The interface
ID is defined as <b>BMPIO_INTERFACE</b>. Through C++ you can access the
...
class IBitmapIO_Exr : public FPStaticInterface
{
public:
...
//! The interface ID is I_SYSTEM_XREF defined in animtbl.h.
...
public:
	...
	//! param[in] headNode - the first node returned from Animtable::GetSystemNodes
