...
public:
	...
	*os) {</b>\n\n
	...
	virtual MSTR *snapname(int index)=0; // the snap’s name to be displayed in the UI
	...
	\par Default Implementation:
	<b>{return NULL;}</b> */
	virtual MSTR *tooltip(int index){return NULL;} // the snap’s name to be displayed in the UI
	...
	contain N icons. The size of an individual icon is 16x15. */
