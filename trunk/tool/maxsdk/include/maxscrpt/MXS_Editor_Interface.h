...
public:
	...
	virtual bool EditFile(char* filename = NULL, bool useOpenfilenameDialogIfFilenameNull = false, char* initialPath = NULL, 
...
public:
	...
	virtual void ExecuteString(const wchar_t *executeString, const char *file_name, int file_offset);
...
public:
	...
	bool Editor_EditFile(char* filename = NULL, bool useOpenfilenameDialogIfFilenameNull = false, char* initialPath = NULL, 
						 int openToPos = -1, Editor_Interface::OpenFlags of = Editor_Interface::ofNone, bool unhide = true, 
						 bool setFocus = true) 
	...
	void MXS_ExecuteString(const wchar_t *executeString, const char *file_name, int file_offset)
		{ MXSEditor_Interface_Instance->ExecuteString(executeString, file_name, file_offset); }
