...
#ifndef I_ACTION_ITEM_OVERRIDE_MANAGER
#define I_ACTION_ITEM_OVERRIDE_MANAGER
#include "MaxHeap.h"
...
public:
	...
	virtual void RegisterActionItemOverride(ActionItem *aItem,TSTR &overrideDescription) =0;
	...
	virtual BOOL IsActionItemRegistered(ActionItem *aItem,TSTR &description) = 0;
