...
public:
	...
	//! \param[in] res  A Tab of TrackViewPick items, each of which specifies a single animatable track, usually from a TrackViewPick dlg. \see TrackViewPick
	//! \return  The name of the file if a file gets loaded, otherwise returns NULL. 
	virtual TCHAR * LoadAnimationDlgFromTracks(const Tab<TrackViewPick> &res)const = 0;
	...
	//! \param[in] res  A Tab of TrackViewPick items, each of which specifies a single animatable track, usually from a TrackViewPick dlg. \see TrackViewPick
	//! \return  The name of the file if a file gets saved, otherwise returns NULL.
	virtual TCHAR * SaveAnimationDlgFromTracks(const Tab<TrackViewPick> &res)const =0;
	...
	//! \param[in] mapFileName  The name of the map file that you want to search and replace attribute strings from.
	//! \param[in] newMapFileName The name of the new map file that will be created with the replaced attribute strings.
	...
	//! was created.
	virtual BOOL ReplaceAttributesInMapFile(TCHAR *mapFileName,TCHAR *newMapFileName,Tab<TSTR*> &oldStrings, Tab<TSTR*> &newStrings,BOOL mapName) const =0;
	...
	//! \param[in] mapFileName The name of the map file you to create with the default mapping.
	//! \return  TRUE if the map file is created, FALSE if for some reason we couldn't create the map file.
	virtual BOOL CreateDefaultMapFile(Tab<INode *> &nodeTab,TCHAR *mapFileName)const = 0;
};
