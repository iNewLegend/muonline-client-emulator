...
#ifndef _IMR_SKY_PORTAL_LIGHT_H_
#define _IMR_SKY_PORTAL_LIGHT_H_
...
public:
	...
	*/
	 ...
	 * Changing this color doesn’t change the light coming in, but has the effect of 
	 * darkening outside objects, which can help if they’re overexposed. To avoid  
