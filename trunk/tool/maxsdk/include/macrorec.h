...
public:
	...
	\par Sample Code:
	<b>macroRecorder-\>SetSelProperty(_T("material"), mr_reftarg,
	(Mtl*)dropThis);</b> */
	...
	\par Sample Code:
	<b>macroRecorder-\>FunctionCall(_T("addModifier"), 2, 1, mr_reftarg, this,
	mr_create, mod-\>ClassID(), mod-\>SuperClassID(), 0, _T("before"), mr_int,
	before);</b>\n\n
	...
	argument is given as <b>_T("before"), mr_int, before</b> which is the
