	...
	for line in io.lines("server.ini") do
		...
		if index == serverIndex then
			if index == 0 then
				...
				g_PlayerMe:setEquip(5,1)
				g_PlayerMe:setEquipSkin(0,1)
				g_PlayerMe:setEquipSkin(1,2)
				g_PlayerMe:setEquipSkin(2,3)
				g_PlayerMe:setEquipSkin(3,4)
				g_PlayerMe:setEquipSkin(4,1)
				--
