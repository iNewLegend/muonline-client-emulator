...
void GMBoxOpen(LPOBJ lpObj)
{
	GMBoxEventItemBag->DropGMBoxEventItem(lpObj->m_Index);
}
...
void RefugeDarkElfItemBagOpen(LPOBJ lpObj, BYTE btMapNumber, BYTE cX, BYTE cY)
{
	RefugeDarkElfItemBag->DropRefugeDarkElfItem(lpObj->m_Index, btMapNumber, cX, cY);
}

void BigDragonItemBagOpen(LPOBJ lpObj, BYTE btMapNumber, BYTE cX, BYTE cY)
{
	BigDragonItemBag->DropBigDragonItem(lpObj->m_Index, btMapNumber, cX, cY);
}

void ZaikanItemBagOpen(LPOBJ lpObj, BYTE btMapNumber, BYTE cX, BYTE cY)
{
	ZaikanItemBag->DropZaikanItem(lpObj->m_Index, btMapNumber, cX, cY);
}

void BigBaliItemBagOpen(LPOBJ lpObj, BYTE btMapNumber, BYTE cX, BYTE cY)
{
	BigBaliItemBag->DropBigBaliItem(lpObj->m_Index, btMapNumber, cX, cY);
}
