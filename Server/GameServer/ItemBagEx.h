...
public:
	...
	int DropGMBoxEventItem(int aIndex);
	...
	int DropRefugeDarkElfItem(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY);
	int DropBigDragonItem(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY);
	int DropZaikanItem(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY);
	int DropBigBaliItem(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY);
