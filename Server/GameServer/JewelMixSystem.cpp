...
static const JEWELMIX_INFO g_JewelMixInfo[2][3] = {10, 500000, ITEMGET(14,13), ITEMGET(12,30),
...
BOOL CJewelMixSystem::MixJewel( int iIndex, int iJewelType, int iMixType)
{
	...
	if ( gObj[iIndex].m_IfState.use > 0 && gObj[iIndex].m_IfState.type != 12)
	{
		...
		lMsgMix->Msg(iIndex," [Anti-Hack] Please dont use hack");
