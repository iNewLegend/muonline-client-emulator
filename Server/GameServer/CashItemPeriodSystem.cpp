...
{
	int iUserIndex = lpObj->m_Index;
	int iUserGuid = lpObj->DBNumber;
...
//			{
//				lpObj->m_ViewSkillState |= 0x8000000;	//Added This Because WebZen sucks while coding
//				GCStateInfoSend(lpObj, TRUE, 0x8000000);
//			}  // REVISAR AQUI!
...
BOOL CCashItemPeriodSystem::ClearPeriodItemEffect(LPOBJ lpObj)
{
	...
	g_ItemAddOption.ClearItemEffect(lpObj, 2);

//	lpObj->m_ViewSkillState &= ~0x8000000;	//Added This Because WebZen sucks while coding
//	GCStateInfoSend(lpObj, 0, 0x8000000); // REVISAR AQUI!
