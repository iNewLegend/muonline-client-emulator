...
#pragma message("Put fclose here CJewelOfHarmony::LoadScript")
	return TRUE;
}
	...
	while ( true )
	{
		...
		if ( Token == NUMBER )
		{
			...
			while ( true )
			{
				...
				Token = (SMDToken)GetToken();
#pragma message("Here must be somthing to put the Name [CJewelOfHarmonySystem::LoadScriptOfSmelt]")
...
#pragma message("Put fclose here CJewelOfHarmony::LoadScriptSmelt")
	return TRUE;
}
