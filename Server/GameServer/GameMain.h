...
#include "DbSave.h"
#include "..\..\shared\include\SimpleModulus.h"
...
struct GameServerRates
{
	int	g_SoulWithLuckRate;
	int	g_SoulWithOutLuckRate;
	int g_LifeRate;
	int g_ItemPlus10MixRate;
	int g_ItemPlus11MixRate;
	int g_ItemPlus12MixRate;
	int g_ItemPlus13MixRate;
	int g_LuckAddRate;
	int g_CondorFeatherChaosMix;
	int g_Wing3ChaosMix;
	int g_CondorFlameDropRate;
	int g_CondorFeatherDropRate;
};

struct GameServerValues
{
	int g_MGDLLevelUpPoints;
	int g_NormalLevelUpPoints;
	int g_QuestAddLevelUpPoints;
	int g_DkAddLifeSkillVitPercent;
	int g_DkAddLifeSkillEnePercent;
	int g_DkAddLifeSkillDuration;
	int g_DarkSpirtReflect;
	int g_AttackReflect;
	int g_WingsLvL2SuccessRate;
};
...
#if(GS_CASTLE)
extern CItemBagEx * HuntZoneItemMixItemBag;
...
extern CItemBagEx * RefugeDarkElfItemBag;
extern CItemBagEx * BigDragonItemBag;
extern CItemBagEx * BigBaliItemBag;
extern CItemBagEx * ZaikanItemBag;
...
extern char szConnectNotice[60];
...
extern BOOL g_bWings3WriteOptionsLog;
extern BOOL g_bWings3ShowInGameOptions;
extern int g_iWings3ReturnDamageSuccessRate;
extern int g_iWings3RecoverFullLifeSuccessRate;
extern int g_iWings3RecoverFullManaSuccessRate;
extern int g_iWings3SuccessfullBlockingRate;

extern BOOL g_bRefugeMonsterDarkElfItemDrop;
extern int g_iRefugeMonsterDarkElfItemDropRate;
extern int g_iRefugeMonsterDarkElfDropZenRate;
extern int g_iRefugeMonsterDarkElfDropZen;

extern BOOL g_bBigDragonItemDrop;
extern int g_iBigDragonItemDropRate;
extern int g_iBigDragonDropZenRate;
extern int g_iBigDragonDropZen;

extern BOOL g_bBigBaliItemDrop;
extern int g_iBigBaliItemDropRate;
extern int g_iBigBaliDropZenRate;
extern int g_iBigBaliDropZen;

extern BOOL g_bZaikanItemDrop;
extern int g_iZaikanItemDropRate;
extern int g_iZaikanDropZenRate;
extern int g_iZaikanDropZen;
...
extern GameServerRates g_ServerRates;
extern GameServerValues g_ServerValues;
extern CPKClear g_PKClear;
extern char szDiplayGSInfo[512];
